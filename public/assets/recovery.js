...
// src/web/recovery.ts
var state = { provider: null, account: null };
var connectBtn = document.getElementById("connect");
var thresholdInput = document.getElementById("threshold");
var totalInput = document.getElementById("total");
var guardiansInput = document.getElementById("guardians");
var genPolicyBtn = document.getElementById("genPolicy");
var exportPolicyBtn = document.getElementById("exportPolicy");
var policyOut = document.getElementById("policyOut");
var initiateBtn = document.getElementById("initiate");
var newKeyInput = document.getElementById("newKey");
var nonceInput = document.getElementById("nonce");
var policyIdView = document.getElementById("policyIdView");
var reqIdView = document.getElementById("reqIdView");
var walletView = document.getElementById("walletView");
...
async function generatePolicy() {
  ...
  if (!threshold || !total || !gds || gds.length === 0) {
    log("Thi\u1EBFu tham s\u1ED1 policy ho\u1EB7c guardians kh\xF4ng h\u1EE3p l\u1EC7.");
    return;
  }
  if (threshold > total) {
  ...
  log("T\u1EA1o policy th\xE0nh c\xF4ng.");
}
...
async function initiateRecovery() {
  ...
  if (state.provider) {
    try {
      ...
      log("\u0110\xE3 kh\u1EDFi ph\xE1t recovery (demo). G\u1EEDi off-chain cho Guardians \u0111\u1EC3 t\u1EA1o ZKP.");
      console.debug({ reqId, sig });
    } catch (e) {
      log(e.message || "Kh\xF4ng th\u1EC3 k\xFD recovery request");
    }
  }
}
function setup() {
